...
def project_list_view(request):
    ...
    checked_social_cause_fields = {value: True for value in request.GET.getlist('socialcause')}
    checked_project_fields = {value: True for value in request.GET.getlist('projectstatus')}
